  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-lg flex-col gap-6 p-8">
      <div className="flex items-center justify-between gap-4">
        ...
        <Link to="/" className="text-muted-foreground text-sm underline underline-offset-4 hover:text-foreground">
          Início
        </Link>
      </div>
      ...
      {isPending ? (
        ...
        <p className="text-muted-foreground">Nenhum utilizador na base de dados.</p>
      ) : (
